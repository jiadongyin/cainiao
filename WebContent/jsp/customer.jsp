		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="<%=basePath%>customer/sb.action"><i
							class="fa fa-dashboard fa-fw"></i> 这个功能还没写</a></li>
					<li><a href="<%=basePath%>customer/uploadDown.action"><i
							class="fa fa-dashboard fa-fw"></i> 图片上传下载</a></li>
					<li><a href="<%=basePath%>customer/fileList.action"><i
							class="fa fa-dashboard fa-fw"></i> 图片列表</a></li>
					<li><a href="<%=basePath%>customer/baiduMap.action"><i
							class="fa fa-dashboard fa-fw"></i> 百度地图</a></li>
					<li><a href="<%=basePath%>customer/baiduMap2.action"><i
							class="fa fa-dashboard fa-fw"></i> 百度地图示例2</a></li>
				</ul>
			</div>
			<!-- /.sidebar-collapse -->
		</div>
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#customerAddDialog" onclick="javaScript(0)">添加</a>
						</div> 
				...
				<div class="modal-body">
					<form class="form-horizontal" id="add_customer_form" >
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="add_linkMan" placeholder="联系人" name="add_linkman">
							</div>
						</div>
						<div class="form-group">
